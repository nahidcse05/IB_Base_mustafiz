...
import ownimplementation.linesearch.LineSearch;
import ownimplementation.linesearch.LineSearchMoreThuente;
import ownimplementation.optimzationTest.Problem1;
import ownimplementation.optimzationTest.Problem14;
import ownimplementation.optimzationTest.Problem18;
import ownimplementation.optimzationTest.Problem2;
import ownimplementation.optimzationTest.Problem3;
import ownimplementation.optimzationTest.Problem5;
import ownimplementation.optimzationTest.Problem6;
import ownimplementation.optimzationTest.QuadraticTest;
import util.Utils;
...
public class ProjectedGradient {
	...
	static public void main(String[] args) {
		...
		for(QuadraticTest testcase:testcases) {
			...
			//Optimizable objFunc, int maxIter, double fdelta, double gdelta, double istp, double ftol, double gtol
