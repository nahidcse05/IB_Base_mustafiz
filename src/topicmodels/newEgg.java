...
public abstract class newEgg {
	...
	public newEgg(int number_of_iteration, double converge, double beta, _Corpus c) {
	...
	public static void main(String[] args) throws IOException, ParseException {	
		...
		String featureValue = "DF"; //The way of calculating the feature value, which can also be "TFIDF", "BM25"
	...
	/*	
		int pos_index [] = {3, 5, 7, 8}; 
		int pos_index_lenght = 4;
		int new_egg[][][] = new int[9][9][1];
		...
		for(int k = 0; k<9; k++)
		{
			for(int l = k + 1; l<9; l++)
				{
					System.out.println("["+k+"]"+"["+l+"]:"+new_egg[k][l][0]);
				}
		}
		System.out.println();
		*/
		...
		analyzer.calculate_PP("./data/amazon/new_Egg_analysis.txt");
